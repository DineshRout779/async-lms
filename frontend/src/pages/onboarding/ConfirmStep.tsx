      ...
      <div className='relative z-10 w-full max-w-[480px] bg-white p-8 sm:px-12 sm:py-10 rounded-3xl shadow-[0_8px_50px_rgba(0,0,0,0.25)] flex flex-col min-h-[500px] text-slate-800'>
        <div className='flex-1'>
          ...
          <div className='mb-8 mt-6 text-center'>
            ...
            <p className='text-[13px] text-slate-400 font-medium mt-1.5 tracking-wide'>
          ...
          <div className='border border-slate-200 rounded-xl overflow-hidden mb-8'>
            ...
            <div className='p-5 border-b border-slate-200 bg-white'>
              <div className='flex justify-between items-center mb-4'>
                <h3 className='text-[13px] font-semibold text-[#344499] tracking-wide'>
                  Personal Information
                </h3>
        ...
        <div className='flex flex-col gap-3 mt-4'>
          <Button
            type='button'
            className='w-full bg-[#344499] hover:bg-[#2c3983] text-white h-11 text-[14px] font-semibold tracking-wide rounded-lg shadow-md transition-colors'
            disabled={loading}
          ...
          <Button
            ...
            type='button'
            className='w-full border-slate-300 text-[#344499] hover:bg-slate-50 hover:text-blue-900 h-11 text-[13px] font-semibold tracking-wide rounded-lg transition-colors'
          >
            Edit details
          </Button>
        </div>
