      ...
      <div className='w-full max-w-[480px] bg-white p-5 sm:px-12 sm:py-10 rounded-xl sm:rounded-3xl shadow-[0_4px_40px_rgba(0,0,0,0.15)] flex flex-col min-h-[350px] sm:min-h-[500px]'>
        ...
        <div className="flex-1">
          ...
          <div className="mb-5 sm:mb-8 mt-4 sm:mt-6">
            <h2 className='text-base sm:text-2xl font-bold text-[#344499]'>Select your batch</h2>
            <p className="text-[8px] sm:text-[13px] text-slate-400 font-medium mt-0.5 sm:mt-1.5 leading-relaxed tracking-wide">Used for cohort tracking and leaderboard ranking</p>
          </div>
