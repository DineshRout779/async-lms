            ...
            {canEdit && (
              <>
                <button
                  ...
                  className='px-3 py-1.5 text-[12px] font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors'
                >
        ...
        <div className='px-6 py-5 overflow-y-auto max-h-[70vh]'>
          {isPreview ? (
            <div className='space-y-6'>
              <div className='prose prose-sm prose-slate max-w-none prose-pre:whitespace-pre-wrap prose-pre:break-words'>
                ...
                <div className='pt-4 border-t border-slate-100'>
                  ...
                  <ul className='space-y-1.5'>
                    {draft.resources.filter(r => r.trim() !== '').map((res, idx) => (
                      <li key={idx}>
                        <a href={res} target='_blank' rel='noreferrer' className='text-[13px] text-indigo-600 hover:underline break-all'>
                          {res}
                        </a>
                      </li>
                    ))}
