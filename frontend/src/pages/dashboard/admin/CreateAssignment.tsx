...
export default function CreateAssignment() {
  ...
  const [, setInstructionUrl] = useState(editData.instructionUrl || '');
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      navigate('/dashboard/admin/assignment-success', {
        state: {
          editId: resId,
          title,
          description,
      ...
      <div className='max-w-3xl mx-auto px-6 py-8 space-y-6 animate-in fade-in duration-500'>
        ...
        <div className='flex items-center gap-3'>
          <button
            ...
            onClick={() => navigate('/dashboard/admin/assignment-management')}
          >
