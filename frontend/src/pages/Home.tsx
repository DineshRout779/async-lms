            ...
            {step === 'welcome' ? (
              ...
              >
                ...
                <Button 
                  ...
                  className="bg-white text-[#344499] hover:bg-slate-100 px-12 h-12 text-lg font-bold rounded-xl transition-all shadow-xl hover:shadow-white/20 active:scale-95"
                >
                  Continue
                </Button>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <span className="text-white font-bold text-lg tracking-wider">CodeGuru</span>
                </motion.div>
                  ...
                  >
                    ...
                    >
                      <CardContent className="flex flex-col items-center justify-center py-12 px-6">
                        ...
                        <p className="font-bold text-[#344499] text-lg">I am a Student</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      <CardContent className="flex flex-col items-center justify-center py-12 px-6">
                        ...
                        <p className="font-bold text-[#344499] text-lg">I am an Instructor</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                </div>
